...
var trans = map[string]map[string]string{
	"zh": {
		...
		"tip.overview":    "颜色：绿色=倍率<0.5（便宜）· 黑色=0.5~1.0（正常）· 橙色=>1.0（偏贵）\n⭐置顶=重点关注（高亮边框+发光）· 普通=正常展示 · 已隐藏=折叠在「更多」里\n在站点详情页底部「分组展示设置」管理置顶/展示/隐藏+拖拽排序",
		...
		"section.alert_override": "告警覆盖（站点级）",
		"form.override.hint":     "留空=继承全局；填值=本站覆盖全局。",
		"form.override.inherit":  "继承全局",
		"form.override.enable":   "启用",
		"form.override.disable":  "禁用",
	...
	"en": {
		...
		"tip.overview":    "Colors: green=ratio<0.5 (cheap) · black=0.5~1.0 (normal) · orange=>1.0 (expensive)\n⭐Pinned=key focus (highlighted border+glow) · Normal=shown · Hidden=collapsed under 'more'\nManage pin/show/hide + drag-reorder in station detail → Group display settings",
		...
		"section.alert_override": "Alert override (per-station)",
		"form.override.hint":     "Leave blank = inherit global; fill = override for this station.",
		"form.override.inherit":  "Inherit global",
		"form.override.enable":   "Enable",
		"form.override.disable":  "Disable",
